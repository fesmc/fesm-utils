module mapping_scrip
    ...
    ! LEGACY: map_scrip_field is the original SCRIP applier. Production mapping now
    ! goes through coords map_field (via map_scrip_to_weight_map / map_read); this
    ! interface is retained only as an independent reference implementation for
    ! tests (see test/coords/test_varslice_map.f90). Do not use in new code.
    ...
    public :: map_scrip_field            ! LEGACY (testing reference only)
